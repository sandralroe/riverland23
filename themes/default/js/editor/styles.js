...
if ('CKEDITOR' in window) {
	...
	CKEDITOR.stylesSet.add('default',
		[
			...
			{ name: 'GkBtnBlkL', element: 'a', attributes: { 'class': 'btn btn-green-left btn-lg' } },
			{ name: 'GkBtnBlkC', element: 'a', attributes: { 'class': 'btn btn-green-center btn-lg' } },
			{ name: 'PkBtnBlkL', element: 'a', attributes: { 'class': 'btn btn-pink-left btn-lg' } },
			{ name: 'PkBtnBlkC', element: 'a', attributes: { 'class': 'btn btn-pink-center btn-lg' } },
			{ name: 'OgBtnBlkL', element: 'a', attributes: { 'class': 'btn btn-orange-left btn-lg' } },
			{ name: 'OgBtnBlkC', element: 'a', attributes: { 'class': 'btn btn-orange-center btn-lg' } },
			{ name: 'GYBtnBlkL', element: 'a', attributes: { 'class': 'btn btn-gray-Left btn-lg' } },
			{ name: 'GYBtnBlkC', element: 'a', attributes: { 'class': 'btn btn-gray-center btn-lg' } },
