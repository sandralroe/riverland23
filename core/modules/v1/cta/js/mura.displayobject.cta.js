Mura.preInit(function(){this["templates"] = this["templates"] || {};
...
this["templates"]["cta"] = window.Mura.Handlebars.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    ...
    render: function() {
        ...
        this.context.afteraction = this.context.afteraction || '';
        this.context.followupurl = this.context.followupurl || '';

        if(this.context.afteraction=='dismiss'){
            this.context.followupurl='';
        }
        if(this.context.followupurl){
            this.context.afteraction='followupurl';
        }
        if (this.context.type == 'modal') {
            ...
            if (this.context.anchory == 'center') {
            this.context.anchory = 'bottom';
            }
        ...
        var region = Mura(this.context.targetEl).closest('.mura-region-local, .mura-region-inherited');
        ...
        if (this.context.type != 'inline' && !Mura('.mura-cta').length) {
            Mura('body').append(this.templates['cta']());
        }
    ...
    initStats: function() {
        ...
        if(!Mura.isNumeric(this.stats.engaged)){
        ...
        if (typeof this.stats.expires == 'string') {
            ...
            if (this.context.resetinterval.toLowerCase() != 'never'
                && !(this.context.hideengaged == 2 && this.stats.engaged) 
                && !(this.context.dismissable == 2 && this.stats.dismissed)
                && this.stats.expires.getTime() < new Date().getTime()) {
                this.stats = {
                    visits: 0,
                    displays: 0,
                    engaged: 0,
                    dismissed: 0,
                    expires: this.addTime(
                        new Date(), 
                        this.context.resetinterval, 
                        this.context.resetqty
                    )
                };
                this.saveStats();
            }
    ...
    display: function() {
        if (!this.displayed) {
            ...
            if (this.context.type === 'inline') {
                Mura(this.context.targetEl).html(this.templates['cta-instance'](this.context));
            } else {
                ...
                if (!region.length) {
                    Mura('.mura-cta').append(this.templates['cta-container'](this.context));
                ...
                region.append(Mura.trim(this.templates['cta-instance'](this.context)));
            }
            var cta = Mura('#mura-cta-' + this.context.instanceid);
            ...
            var region = Mura(self.context.targetEl).closest('.mura-region-local, .mura-region-inherited');
            ...
            if (this.context.componentid && this.context.componentid != 'notconfigured') {
                if(!cta.find('[data-ctaid="' + this.context.instanceid + '"][data-object="component"]').length){
                    cta.find('.mura-cta__item__content').appendDisplayObject({
                            ...
                            source: this.context.componentid,
                            ctaid: this.context.instanceid,
                            transient:false,
                            queue: false
                    });
            ...
            if (this.context.formid && this.context.formid != 'notconfigured') {
                if(!cta.find('[data-ctaid="' + this.context.instanceid + '"][data-object="form"]').length){
                    cta.find('.mura-cta__item__content').appendDisplayObject({
                        ...
                        queue: false,
                        transient:false,
                        followupurl: this.context.followupurl
                    });
                }
                isEmpty = false;
            }
            ...
            if (isEmpty) {
                cta.find('.mura-cta__item__content').html('<p>No content has been assigned.</p>');
            }
            ...
            if (this.context.nestedobject && this.context.nestedobject !=
                ...
                cta.on('formSubmitSuccess', function(e) {
                    if(self.context.afteraction.toLowerCase()=='dismiss'){
                        setTimeout(
                            function() {
                            cta.find('.mura-cta__item__dismiss').trigger('click');
                            },
            ...
            if (this.context.componentid 
                && this.context.componentid != 'notconfigured') {
            ...
            if (this.context.formid
                && this.context.formid != 'notconfigured') {
    ...
    checkRequirements: function() {
        ...
        */
        ...
        if (this.preview || (this.metDelayRequirement() &&
                ...
                && this.metVisitsRequirement() 
                && this.metDisplaysRequirement()
                && this.metEnagagedRequirement()
                && this.metDismissedRequirement()
            )
        ) {
            this.display();
        }
    },
    metEnagagedRequirement: function() {
        return !(this.context.hideengaged && this.stats.engaged);
    },
    metDismissedRequirement: function() {
        return !(this.context.dismissable && this.stats.dismissed);
    },
    metVisitsRequirement: function() {
        return (!this.context.visits || (this.stats.visits >=  this.context.visits));
    },
    metDisplaysRequirement: function() {
        return (!this.context.displays || (this.context.displays > this.stats.displays));
    },
...
Mura.DisplayObject.Cta=Mura.DisplayObject.Cta.extend({templates:this.templates});});