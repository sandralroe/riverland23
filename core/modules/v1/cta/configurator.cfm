<cfsilent>
    ...
    <cfparam name="objectparams.resetinterval" default="session">
    <cfparam name="objectparams.resetqty" default="1">
    <cfparam name="objectparams.hideengaged" default="0">
    <cfparam name="objectparams.dismissible" default="0">
    ...
    <cfparam name="objectParams.afteraction" default="">

    <cfif len(objectParams.followupurl)>
        <cfset objectParams.afteraction="followupurl">
    </cfif>
          ...
          <div class="mura-panel-body">
            <div class="mura-control-group">
                <div class="mura-control-group">
                    ...
                    <select id="componentid" name="componentid" data-param="componentid" class="objectParam">
                ...
                <div class="mura-control-group">
                    ...
                    <select id="formid" name="formid" data-param="formid" class="objectParam">
                        <option value="notconfigured">
                    ...
                    <label class="mura-control-label">After Action</label>
                    <select id="afteraction" name="afteraction" class="objectParam" data-param="afteraction">
                        <option value="none" <cfif not listFindNoCase('followupurl,dismiss',objectparams.afteraction)> selected</cfif>>None</option>
                        <option value="followupurl"<cfif "followupurl" eq objectparams.afteraction> selected</cfif>>Follow Up URL</option>
                        <option value="dismiss"<cfif "dismiss" eq objectparams.afteraction> selected</cfif>>Dismiss</option>
                    </select>
               
                    <div class="mura-control-group" id="followupurlcontainer"<cfif objectparams.afteraction neq 'followupurl'> style="display:none;"</cfif>>
            ...
            <div class="mura-control-group">
                ...
                <div class="mura-control-group">
                    ...
                    <select name="resetinterval" class="objectParam">
                        <cfset options=['Session','Day','Week','Month','Never']>
                ...
                <div class="mura-control-group">
                    <label class="mura-control-label">#application.rbFactory.getKeyValue(session.rb,'cta.dismissible')#</label>
                    <select name="dismissible" class="objectParam">
                        <option value="0" <cfif not objectparams.dismissible> selected</cfif>>until next visit</option>
                        <option value="1" <cfif objectparams.dismissible eq 1> selected</cfif>>until CTA restarts</option>
                        <option value="2" <cfif objectparams.dismissible eq 2> selected</cfif>>permanently</option>
                    </select>
                </div>
                <div class="mura-control-group">
                    ...
                    <select name="hideengaged" class="objectParam">
                        <option value="0" <cfif not objectparams.hideengaged> selected</cfif>>until next visit</option>
                        <option value="1" <cfif objectparams.hideengaged eq 1> selected</cfif>>until CTA restarts</option>
                        <option value="2" <cfif objectparams.hideengaged eq 2> selected</cfif>>permanently</option>
                    </select>
                </div>
            </div>
          </div>
      ...
      <div class="mura-panel">
        ...
        <div id="panel-3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-3">
          <div class="mura-panel-body">
            <div class="mura-control-group">
                ...
                <div id="modal-option-container" class="render-option-container" style="display:none">
                    ...
                    <div class="mura-control-group">
                        ...
                        <select id="animate" name="animatemodal" data-param="animate">
                    ...
                    <div class="mura-control-group">
                        ...
                        <select id="animatespeed" name="animatespeedmodal" data-param="animatespeed">
                    ...
                    <div class="mura-control-group">
                        ...
                        <select name="widthmodal" data-param="width">
                ...
                <div id="drawer-option-container" class="render-option-container" style="display:none">
                    ...
                    <div class="mura-control-group">
                        ...
                        <select id="drawer-anchorx" name="anchorxdrawer" data-param="anchorx">
                    ...
                    <div class="mura-control-group">
                        ...
                        <select id="drawer-anchory" name="anchorydrawer" data-param="anchory">
                    ...
                    <div class="mura-control-group">
                        <label class="mura-control-label">#application.rbFactory.getKeyValue(session.rb,'cta.animationspeed')#</label>
                        <select name="animatespeeddrawer" data-param="animatespeed">
                            <cfset options=['slow','medium','fast']>
                            <cfloop array="#options#" item="option">
                                <option value="#lcase(option)#"<cfif option eq objectparams.animatespeed> selected</cfif>>#application.rbFactory.getKeyValue(session.rb,'cta.#option#')#</option>
                            </cfloop>
                    ...
                    <div class="mura-control-group">
                        <label class="mura-control-label">#application.rbFactory.getKeyValue(session.rb,'cta.width')#</label>
                        <select name="widthdrawer" data-param="width">
                            <option value="sm"<cfif 'sm' eq objectparams.width> selected</cfif>>#application.rbFactory.getKeyValue(session.rb,'cta.small')#</option>
                            <option value="md"<cfif 'md' eq objectparams.width> selected</cfif>>#application.rbFactory.getKeyValue(session.rb,'cta.medium')#</option>
                            <option value="lg"<cfif 'lg' eq objectparams.width> selected</cfif>>#application.rbFactory.getKeyValue(session.rb,'cta.large')#</option>
                        </select>
                ...
                <div id="bar-option-container" class="render-option-container" style="display:none">
                    <div class="mura-control-group">
                        <label class="mura-control-label">#application.rbFactory.getKeyValue(session.rb,'cta.animationspeed')#</label>
                        <select name="animatespeedbar" data-param="animatespeed">
                            <cfset options=['slow','medium','fast']>
                            <cfloop array="#options#" item="option">
                                <option value="#lcase(option)#"<cfif option eq objectparams.animatespeed> selected</cfif>>#application.rbFactory.getKeyValue(session.rb,'cta.#option#')#</option>
                            </cfloop>
            ...
            <div class="mura-control-group">
                <label class="mura-control-label">Stats ID</label>
                <input name="statsid" type="text" class="objectParam" value="#esapiEncode('html_attr',objectParams.statsid)#">
                <button id="resetStatsID" class="btn">Reset Stats ID</button>
                <script>
                    Mura(function(){
                        Mura('##resetStatsID').on('click',function(){
                            $('input[name="statsid"]').val(Mura.createUUID()).trigger('change');
                        });
                    });
                </script>
            </div>
...
<input name="preview"  class="objectParam" type="hidden" value="true"/>
<script>
    Mura(function(){
        ...
        jQuery('##afteraction').on('change',function(){
            if(Mura('##afteraction').val()==='followupurl'){
                Mura('##followupurlcontainer').show();
            } else {
                Mura('##followupurlcontainer').hide();
            }
        });
