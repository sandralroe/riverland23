<!--- license goes here --->
<cfcomponent extends="mura.baseobject" output="false" hint="Provide extend type/subtype CRUD functionality">
	...
	<cffunction name="getExtendSetBean">
		<cfset var extendSetBean=new mura.extend.extendSet(variables.configBean,getContentRenderer()) />
	...
	<cffunction name="getExtendSets" returntype="array">
		...
		<cfelse>
			...
			<cfif rsSets.recordcount>
				<cfset tempArray=new mura.queryTool(rsSets).toArray() />
