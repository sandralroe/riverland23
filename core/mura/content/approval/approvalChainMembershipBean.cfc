/* license goes here */
component extends="mura.bean.beanORM"  table="tapprovalmemberships" orderby="orderno asc" entityname="approvalChainMembership" bundleable=true hint="This provides approval chain membership functionality" {
