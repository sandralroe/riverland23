component extends="mura.bean.beanORM" table="tentity" entityname="entity" orderby="name"{
  ...
  function getDynamic(){
    return (isDefined('variables.instance.dynamic') && variables.instance.dynamic) ? 1 :0;
  }
  ...
  function getScaffold(){
    return (isDefined('variables.instance.scaffold') && variables.instance.scaffold) ? 1 : 0;
  }
  ...
  function getBundleable(){
    return (isDefined('variables.instance.bundleable') && variables.instance.bundleable) ? 1 :0;
  }
