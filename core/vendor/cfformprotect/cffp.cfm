...
<cfif cffpConfig.hiddenFormField>
	<cfset fphiddenitextd="fp#createuuid()#">
	...
	<label for="<cfoutput>#fphiddenitextd#</cfoutput>" style="display:none">Leave this field empty <input id="<cfoutput>#fphiddenitextd#</cfoutput>" type="text" name="formfield1234567894" value="" /></label>
</cfif>