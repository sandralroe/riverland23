...
<cfif rc.layoutmanager>
	<div class="mura-layout-row">
		...
		<select name="subClassSelector"
		        onchange="mura.loadObjectClass('#rc.siteid#','gallery',this.value,'#rc.contentid#','#rc.parentid#','#rc.contenthistid#','#rc.instanceid#');"
		        class="dropdown">
			<option value="">
...
<cfelse>
	<div class="mura-layout-row">
		<div class="mura-control-group">
			<select name="subClassSelector"
			        onchange="siteManager.loadObjectClass('#rc.siteid#','gallery',this.value,'#rc.contentid#','#rc.parentid#','#rc.contenthistid#','#rc.instanceid#');"
			        class="dropdown">
				<option value="">
					#application.rbFactory.getKeyValue(session.rb, 'sitemanager.content.fields.selectgallery')#
				</option>
