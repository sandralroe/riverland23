<cfsilent>
	...
	<cfset url.object='plugin'>
</cfsilent>
<cfoutput>
<cf_objectconfigurator params="#url#">
	<div class="mura-layout-row">
		<div class="mura-control-group">
			<label>Select Plugin</label>
			<select name="subClassSelector"
			        onchange="siteManager.loadObjectClass('#rc.siteid#','plugin',this.value,'#rc.contentid#','#rc.parentid#','#rc.contenthistid#','#rc.instanceid#');">
				<option value="">
