...
<cfif true or rc.$.validateCSRFTokens(context="approvalaction")>
	...
	<cfset data={contenthistid=approvalRequest.getContentHistID(),previewurl=content.getURL(querystring="previewid=#approvalRequest.getContentHistID()#",useEditRoute=true)}>
