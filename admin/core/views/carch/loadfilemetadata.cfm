		  	...
		  	<div class="block block-bordered">
				...
				<div class="block-content">
					...
					<div class="mura-control-group">
						...
						<textarea id="file-caption" data-property="caption" class="filemeta #editorclass#">#fileMetaData.getCaption()#</textarea>
					</div>
					<div class="mura-control-group">
						<label>
							#application.rbFactory.getKeyValue(session.rb,'sitemanager.filemetadata.credits')#
						</label>
						<textarea id="file-credits" data-property="credits" class="filemeta #editorclass#">#fileMetaData.getCredits()#</textarea>
					</div>
					<div class="mura-control-group">
						<label>
