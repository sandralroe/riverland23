...
<div id="image-details">
	...
	<a class="ui__back" href="#rc.contentBean.getEditURL(compactDisplay=rc.compactDisplay)#&bigui=assoc##panel-assoc">#application.rbFactory.getKeyValue(session.rb,'sitemanager.done')# <i class="mi-angle-right"></i></a>
	</cfif>
