...
<cfset optionStartOffset=0>
<cfset rsParams=rc.feedBean.getAdvancedParams()/>
<cfif rc.$.getServiceFactory().containsBean('marketingManager')>
	<cfset options[1][1]="persona">
	<cfset options[1][2]="Persona">
	<cfset options[2][1]="stage">
	<cfset options[2][2]="Stage">
	<cfset optionStartOffset=2>
</cfif>
<cfset options[optionStartOffset+1][1]="tcontent.lastupdate^date">
<cfset options[optionStartOffset+1][2]=application.rbFactory.getKeyValue(session.rb,'params.lastupdate')>
<cfset options[optionStartOffset+2][1]="tcontent.releaseDate^date">
<cfset options[optionStartOffset+2][2]=application.rbFactory.getKeyValue(session.rb,'params.releasedate')>
<cfset options[optionStartOffset+3][1]="tcontent.created^date">
<cfset options[optionStartOffset+3][2]=application.rbFactory.getKeyValue(session.rb,'params.created')>
<cfset options[optionStartOffset+4][1]="tcontent.menuTitle^varchar">
<cfset options[optionStartOffset+4][2]=application.rbFactory.getKeyValue(session.rb,'params.menutitle')>
<cfset options[optionStartOffset+5][1]="tcontent.title^varchar">
<cfset options[optionStartOffset+5][2]=application.rbFactory.getKeyValue(session.rb,'params.title')>
<cfset options[optionStartOffset+6][1]="tcontent.Credits^varchar">
<cfset options[optionStartOffset+6][2]=application.rbFactory.getKeyValue(session.rb,'params.credits')>
<cfset options[optionStartOffset+7][1]="tcontent.summary^varchar">
<cfset options[optionStartOffset+7][2]=application.rbFactory.getKeyValue(session.rb,'params.summary')>
<cfset options[optionStartOffset+8][1]="tcontent.body^varchar">
<cfset options[optionStartOffset+8][2]=application.rbFactory.getKeyValue(session.rb,'params.body')>
<cfset options[optionStartOffset+9][1]="tcontent.metaDesc^varchar">
<cfset options[optionStartOffset+9][2]=application.rbFactory.getKeyValue(session.rb,'params.metadesc')>
<cfset options[optionStartOffset+10][1]="tcontent.metaKeywords^varchar">
<cfset options[optionStartOffset+10][2]=application.rbFactory.getKeyValue(session.rb,'params.metakeywords')>
<cfset options[optionStartOffset+11][1]="tcontent.type^varchar">
<cfset options[optionStartOffset+11][2]=application.rbFactory.getKeyValue(session.rb,'params.type')>
<cfset options[optionStartOffset+12][1]="tcontent.subType^varchar">
<cfset options[optionStartOffset+12][2]=application.rbFactory.getKeyValue(session.rb,'params.subtype')>
<cfset options[optionStartOffset+13][1]="tcontenttags.tag^varchar">
<cfset options[optionStartOffset+13][2]=application.rbFactory.getKeyValue(session.rb,'params.tag')>
<cfset options[optionStartOffset+14][1]="tcontent.displayStart^timestamp">
<cfset options[optionStartOffset+14][2]=application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.startdatetime')>
<cfset options[optionStartOffset+15][1]="tcontent.displayStop^timestamp">
<cfset options[optionStartOffset+15][2]=application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.stopdatetime')>
<cfset options[optionStartOffset+16][1]="tcontent.expires^timestamp">
<cfset options[optionStartOffset+16][2]=application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.expires')>
<cfset options[optionStartOffset+17][1]="tcontent.contentID^varchar">
<cfset options[optionStartOffset+17][2]="Content ID"/>
<cfset options[optionStartOffset+18][1]="tcontent.parentID^varchar">
<cfset options[optionStartOffset+18][2]="Parent ID"/>
<cfset options[optionStartOffset+19][1]="tcontent.path^varchar">
<cfset options[optionStartOffset+19][2]="Path"/>
<cfset options[optionStartOffset+20][1]="tcontentcategoryassign.categoryID^varchar">
<cfset options[optionStartOffset+20][2]="Category ID"/>
<cfset options[optionStartOffset+21][1]="tcontent.filename^varchar">
<cfset options[optionStartOffset+21][2]="Filename"/>

<cfif rc.$.getServiceFactory().containsBean('marketingManager')>
	<cfset options[arrayLen(options)+1][1]="personaid">
	<cfset options[arrayLen(options)][2]="Persona ID">
	<cfset options[arrayLen(options)+1][1]="stageid">
	<cfset options[arrayLen(options)][2]="Stage ID">
	<cfset optionStartOffset=2>
</cfif>
...
<cfset options[arrayLen(options)+1][1]="#rsExtend.attributeID#^varchar">
<cfset options[arrayLen(options)][2]="#rsExtend.Type#/#rsExtend.subType# - #rsExtend.attribute#"/>
</cfloop>
...
<form <cfif rc.compactDisplay eq "true">style="padding-top:15px;"</cfif> novalidate="novalidate" action="./?muraAction=cFeed.update&siteid=#esapiEncode('url',rc.siteid)#" method="post" name="form1" id="feedFrm" onsubmit="return validate(this);"<cfif len(rc.assignmentID)> style="width: 412px"</cfif>>
						...
						<tbody id="ContentFilters">
							...
							<cfif rc.rslist.recordcount>
								<cfloop query="rc.rslist">
									...
									<cfif item.exists()>
										<cfset started=true>
										<tr id="del-#rc.rslist.contentID#">
											<td class="actions"><input type="hidden" name="contentID" value="#rc.rslist.contentid#" /><ul class="clearfix"><li class="delete"><a title="Delete" href="javascript:void(0);" onclick="feedManager.removeFilter('#rc.rslist.contentid#'); return false;"><i class="mi-trash"></i></a></li></ul></td>
