...
<cfelseif rc.muraAction eq "core:cwebservice.save">
    <div class="alert alert-success"><span>This Web Service has been saved.</span></div>
</cfif>

<cfif not rc.$.siteConfig('useSSL') and not rc.$.getBean('utility').isHTTPS()>
