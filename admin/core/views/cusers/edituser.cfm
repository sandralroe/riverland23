					...
					<div id="tabBasic" class="tab-pane active">
						<div class="block block-bordered">
							...
							<div class="mura-control-group">
									...
									<input id="fname" name="fname" maxlength="50" type="text" value="#esapiEncode('html',rc.userBean.getfname())#"  required="true" message="#rbKey('user.fnamerequired')#">
								</div>

							<div class="mura-control-group">
									<label for="lname">#rbKey('user.lname')#*</label>
									<input id="lname" name="lname" maxlength="50" type="text" value="#esapiEncode('html',rc.userBean.getlname())#"  required="true" message="#rbKey('user.lnamerequired')#">
							</div>

							<!--- Company + Title --->
							<div class="mura-control-group">
								<label for="organization">#rbKey('user.company')#</label>
								<input id="organization" name="company" maxlength="100" type="text" value="#esapiEncode('html',rc.userBean.getcompany())#">
								</div>

							<div class="mura-control-group">
								<label for="jobtitle">#rbKey('user.jobtitle')#</label>
								<input id="jobtitle" name="jobtitle" maxlength="50" type="text" value="#esapiEncode('html',rc.userBean.getjobtitle())#">
							</div>

							<!--- Email + Phone --->
							<div class="mura-control-group">
								<label for="email">#rbKey('user.email')#*</label>
								<input <cfif lockedSuper>disabled</cfif> id="email" name="email" maxlength="255" type="text" value="#esapiEncode('html',rc.userBean.getemail())#" required="true" validate="email" message="#rbKey('user.emailvalidate')#">
								</div>

							<div class="mura-control-group">
								<label for="mobilePhone">#rbKey('user.mobilephone')#</label>
								<input id="mobilePhone" name="mobilePhone" maxlength="50" type="text" value="#esapiEncode('html',rc.userBean.getMobilePhone())#">
							</div>

							<!--- Username --->
							<div class="mura-control-group">
								<label for="username">#rbKey('user.username')#*</label>
								<input <cfif lockedSuper>disabled</cfif> id="username"  name="usernameNoCache" maxlength="255" type="text" value="#esapiEncode('html',rc.userBean.getusername())#" required="true" message="The 'Username' field is required" autocomplete="off">
							</div>
							<cfif not lockedSuper>
								...
								<div class="mura-control-group">
									...
									<input id="passwordNoCache" name="passwordNoCache" autocomplete="new-password" validate="match" matchfield="password2" type="password" value=""  message="#rbKey('user.passwordmatchvalidate')#">
									</div>

								<div class="mura-control-group">
									<label for="password2">#rbKey('user.newpasswordconfirm')#**</label>
									<input id="password2" name="password2" autocomplete="new-password" type="password" value="" message="#rbKey('user.passwordconfirm')#">
								</div>
							</cfif>
							...
							<div class="mura-control-group">
								...
								<cf_fileselector name="newfile" property="photofileid" bean="#rc.userBean#" deleteKey="removePhotoFile" compactDisplay="#rc.compactDisplay#" examplefileext="JPG" maxUploadFileSize="#application.configBean.getValue('maxuploadfilesize')#">
							</div>
					...
					<div id="tabGroupmemberships" class="tab-pane">
						<div class="block block-bordered">
									...
									jQuery(document).ready(function($){
										...
										$('input[name="isPublic"]').click(function(e){
											...
											if($('input[name="isPublic"]:checked').val()==1){
												...
												$('##superAdminAccountDiv').hide();
											} else {
												$('##privateGroupsList').show();
												$('##superAdminAccountDiv').show();
											}
										});
							...
							<cfif rc.$.currentUser().isSuperUser()>
								<div class="mura-control-group" id="superAdminAccountDiv" 
						...
						<cfif YesNoFormat(rc.$.siteConfig('EmailBroadcaster'))>
							...
							<cfif rc.userBean.exists()>
								...
								<div class="mura-control-group">
									...
									<cfelse>
										<div class="help-block-empty"><p>This user has not connected through any web services.</p></div>
									</cfif>
								</div>
							</cfif>
				...
				<cfif isEditor>
					<div class="mura-actions">
						<div class="form-actions">
							...
							<cfelse>
								<cfif not lockedSuper>
									<button <cfif rc.userid eq rc.$.currentUser().get('userid')>disabled</cfif> type="button" class="btn" onclick="submitForm(document.forms.form1,'delete','#jsStringFormat(rbKey('user.deleteuserconfirm'))#');"><i class="mi-trash"></i>#rbKey('user.delete')#</button>
								</cfif>
